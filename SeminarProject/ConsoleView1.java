...
//
//                str = "|" + getColor(Main.darkSide.get(i), 2) + Main.darkSide.get(i).getName().toUpperCase().charAt(0) + AnsiColors.ANSI_RESET + "|"
...
//                str = "|" + getColor(Main.whiteSide.get(i), 1) + Main.whiteSide.get(i).getName().toUpperCase().charAt(0) + AnsiColors.ANSI_RESET;
//            }
//        }
//        return str;
//    }
